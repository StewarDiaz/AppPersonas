...
public class PaypalClient extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paypal_client);

        Tmonto = findViewById(R.id.etEdtAmount);
